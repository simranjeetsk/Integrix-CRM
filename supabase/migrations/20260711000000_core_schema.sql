...
create table public.rate_cards (
  ...
  pf_employer_epf_pct numeric(5, 2) not null default 12,
  pf_employer_edli_pct numeric(5, 2) not null default 0.5,
  pf_employer_admin_pct numeric(5, 2) not null default 0.5,
